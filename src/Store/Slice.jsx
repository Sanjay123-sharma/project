...
export const Slice=createSlice({
    ...
    reducers:{
        addOrder:(state,action)=>{
            ...
            state.Cart.push({id:product.id,count:1,title:product.title,rating:product.rating,price:product.price,image:product.image})
        },
...
export const {addOrder,removeOrder,increment,decrement,Orders,removeAllCart,cancelOrder}=Slice.actions;
